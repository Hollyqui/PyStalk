...
# Hollyqui edited:
# added additional parameter (only_get) which allows the user to specify
# a single type of object for which the boxes are returned
def visualize_boxes_and_labels_on_image_array(
    ...
    Args:
      ...
      only_get: only draws boxes for a single class
...
# Hollyqui edited
# returns all the box coordinates as an array
